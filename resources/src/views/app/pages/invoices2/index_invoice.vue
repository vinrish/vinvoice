<template>
    <div class="main-content">
        <breadcumb :page="$t('Invoices_list')" :folder="$t('invoices')" />
                    ...
                    <span v-if="props.column.field == 'actions'">
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item title="Show" :to="'/app/invoices2/detail/'+props.row.id">
                                    <i class="nav-icon i-Eye font-weight-bold mr-2"></i>
                                    {{$t('Invoice Detail')}}
                                </b-dropdown-item>
                                <b-dropdown-item
                                    title="Edit"
                                    :to="'/app/invoices2/edit/'+props.row.id"
                                >
